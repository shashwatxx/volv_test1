...
/// A vertical scroller
///
/// Use [VolvCustomScroller] as you would `ListView.Builder()`
class VolvCustomScroller extends StatefulWidget {
  const VolvCustomScroller({
    Key? key,
  ...
  @override
  _VolvCustomScrollerState createState() => _VolvCustomScrollerState();
}

class _VolvCustomScrollerState extends State<VolvCustomScroller>
